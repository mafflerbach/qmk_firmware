...
**Hardware files for the Let's Split are now stored at http://qmk.fm/holymoly/**
...
```
$ make holymoly/rev2:default
```

You will see a lot of output and if everything worked correctly you will see the built hex file:

```
holymoly_rev2_default.hex
```
...
```
$ make holymoly/rev2:YOUR_KEYMAP_NAME
```

If everything worked correctly you will see a file:

```
holymoly_rev2_YOUR_KEYMAP_NAME.hex
```
...
Example: `make holymoly/rev2:default:avrdude`
